...
public interface XPathFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Additional In</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Additional In</em>'.
   * @generated
   */
  AdditionalIn createAdditionalIn();
  ...
  /**
   * Returns a new object of class '<em>NC Name</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>NC Name</em>'.
   * @generated
   */
  NCName createNCName();
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>PIT Test</em>'.
   * @generated
   */
  PITTest createPITTest();
