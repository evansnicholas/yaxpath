...
public class AttributeNameImpl extends MinimalEObjectImpl.Container implements AttributeName
{
  ...
  public NotificationChain basicSetQName(QName newQName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPathPackage.ATTRIBUTE_NAME__QNAME, oldQName, newQName);
  ...
  public void setQName(QName newQName)
  {
    if (newQName != qName)
    {
      ...
      if (qName != null)
        msgs = ((InternalEObject)qName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPathPackage.ATTRIBUTE_NAME__QNAME, null, msgs);
      if (newQName != null)
        msgs = ((InternalEObject)newQName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPathPackage.ATTRIBUTE_NAME__QNAME, null, msgs);
      msgs = basicSetQName(newQName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XPathPackage.ATTRIBUTE_NAME__QNAME, newQName, newQName));
  }
