 ...
 * <ul>
 *   <li>{@link org.xtext.example.xpath.xPath.impl.AttributeDeclarationImpl#getAttName <em>Att Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeDeclarationImpl extends MinimalEObjectImpl.Container implements AttributeDeclaration
{
  ...
  {
    return XPathPackage.Literals.ATTRIBUTE_DECLARATION;
  }
  ...
  public NotificationChain basicSetAttName(AttributeName newAttName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPathPackage.ATTRIBUTE_DECLARATION__ATT_NAME, oldAttName, newAttName);
  ...
  public void setAttName(AttributeName newAttName)
  {
    if (newAttName != attName)
    {
      ...
      if (attName != null)
        msgs = ((InternalEObject)attName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPathPackage.ATTRIBUTE_DECLARATION__ATT_NAME, null, msgs);
      if (newAttName != null)
        msgs = ((InternalEObject)newAttName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPathPackage.ATTRIBUTE_DECLARATION__ATT_NAME, null, msgs);
      msgs = basicSetAttName(newAttName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XPathPackage.ATTRIBUTE_DECLARATION__ATT_NAME, newAttName, newAttName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XPathPackage.ATTRIBUTE_DECLARATION__ATT_NAME:
