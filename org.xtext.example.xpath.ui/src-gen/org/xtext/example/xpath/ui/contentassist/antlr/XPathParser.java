		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRelativePathExprAccess().getAlternatives_1_0(), "rule__RelativePathExpr__Alternatives_1_0");
					...
					put(grammarAccess.getPathExprAccess().getGroup_0_1(), "rule__PathExpr__Group_0_1__0");
					...
					put(grammarAccess.getPathExprAccess().getSinglePathAssignment_0_1_1(), "rule__PathExpr__SinglePathAssignment_0_1_1");
					put(grammarAccess.getPathExprAccess().getDoublePathAssignment_1_1(), "rule__PathExpr__DoublePathAssignment_1_1");
					put(grammarAccess.getPathExprAccess().getPathAssignment_2(), "rule__PathExpr__PathAssignment_2");
					put(grammarAccess.getRelativePathExprAccess().getLeftAssignment_0(), "rule__RelativePathExpr__LeftAssignment_0");
					put(grammarAccess.getRelativePathExprAccess().getRightsAssignment_1_1(), "rule__RelativePathExpr__RightsAssignment_1_1");
					put(grammarAccess.getStepExprAccess().getFilterAssignment_0(), "rule__StepExpr__FilterAssignment_0");
					put(grammarAccess.getStepExprAccess().getStepAssignment_1(), "rule__StepExpr__StepAssignment_1");
					put(grammarAccess.getAxisStepAccess().getReverseAssignment_0_0(), "rule__AxisStep__ReverseAssignment_0_0");
					put(grammarAccess.getAxisStepAccess().getForwardAssignment_0_1(), "rule__AxisStep__ForwardAssignment_0_1");
					...
					put(grammarAccess.getNodeTestAccess().getKindTestAssignment_0(), "rule__NodeTest__KindTestAssignment_0");
					put(grammarAccess.getNodeTestAccess().getNodeTestAssignment_1(), "rule__NodeTest__NodeTestAssignment_1");
