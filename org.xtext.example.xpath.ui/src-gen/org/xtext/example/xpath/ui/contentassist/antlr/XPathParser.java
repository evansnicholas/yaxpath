		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUnaryExprAccess().getUnaryOpsAlternatives_0_0(), "rule__UnaryExpr__UnaryOpsAlternatives_0_0");
					...
					put(grammarAccess.getMultiplicativeExprAccess().getGroup_1_0_2(), "rule__MultiplicativeExpr__Group_1_0_2__0");
					put(grammarAccess.getMultiplicativeExprAccess().getGroup_1_0_3(), "rule__MultiplicativeExpr__Group_1_0_3__0");
					...
					put(grammarAccess.getUnionExprAccess().getGroup_1_0_0(), "rule__UnionExpr__Group_1_0_0__0");
					put(grammarAccess.getUnionExprAccess().getGroup_1_0_1(), "rule__UnionExpr__Group_1_0_1__0");
					...
					put(grammarAccess.getIntersectExceptExprAccess().getGroup_1_0_0(), "rule__IntersectExceptExpr__Group_1_0_0__0");
					put(grammarAccess.getIntersectExceptExprAccess().getGroup_1_0_1(), "rule__IntersectExceptExpr__Group_1_0_1__0");
					...
					put(grammarAccess.getXpathAccess().getXpathAssignment(), "rule__Xpath__XpathAssignment");
					...
					put(grammarAccess.getComparisonExprAccess().getLeftAssignment_0(), "rule__ComparisonExpr__LeftAssignment_0");
					put(grammarAccess.getComparisonExprAccess().getCompAssignment_1_0_0(), "rule__ComparisonExpr__CompAssignment_1_0_0");
					put(grammarAccess.getComparisonExprAccess().getCompAssignment_1_0_1(), "rule__ComparisonExpr__CompAssignment_1_0_1");
					put(grammarAccess.getComparisonExprAccess().getCompAssignment_1_0_2(), "rule__ComparisonExpr__CompAssignment_1_0_2");
					put(grammarAccess.getComparisonExprAccess().getRightAssignment_1_1(), "rule__ComparisonExpr__RightAssignment_1_1");
					...
					put(grammarAccess.getUnionExprAccess().getRightAssignment_1_1(), "rule__UnionExpr__RightAssignment_1_1");
					put(grammarAccess.getIntersectExceptExprAccess().getRightAssignment_1_1(), "rule__IntersectExceptExpr__RightAssignment_1_1");
					put(grammarAccess.getInstanceofExprAccess().getRightAssignment_1_3(), "rule__InstanceofExpr__RightAssignment_1_3");
					put(grammarAccess.getTreatExprAccess().getRightAssignment_1_3(), "rule__TreatExpr__RightAssignment_1_3");
					put(grammarAccess.getCastableExprAccess().getRightAssignment_1_3(), "rule__CastableExpr__RightAssignment_1_3");
					put(grammarAccess.getCastExprAccess().getRightAssignment_1_3(), "rule__CastExpr__RightAssignment_1_3");
					put(grammarAccess.getUnaryExprAccess().getUnaryOpsAssignment_0(), "rule__UnaryExpr__UnaryOpsAssignment_0");
					put(grammarAccess.getUnaryExprAccess().getValueAssignment_1(), "rule__UnaryExpr__ValueAssignment_1");
					put(grammarAccess.getValueExprAccess().getValueAssignment(), "rule__ValueExpr__ValueAssignment");
					put(grammarAccess.getGeneralCompAccess().getOpAssignment_0(), "rule__GeneralComp__OpAssignment_0");
					put(grammarAccess.getGeneralCompAccess().getOpAssignment_1(), "rule__GeneralComp__OpAssignment_1");
					put(grammarAccess.getGeneralCompAccess().getOpAssignment_2(), "rule__GeneralComp__OpAssignment_2");
					put(grammarAccess.getGeneralCompAccess().getOpAssignment_3(), "rule__GeneralComp__OpAssignment_3");
					put(grammarAccess.getGeneralCompAccess().getOpAssignment_4(), "rule__GeneralComp__OpAssignment_4");
					put(grammarAccess.getGeneralCompAccess().getOpAssignment_5(), "rule__GeneralComp__OpAssignment_5");
					put(grammarAccess.getValueCompAccess().getOpAssignment_0(), "rule__ValueComp__OpAssignment_0");
					put(grammarAccess.getValueCompAccess().getOpAssignment_1(), "rule__ValueComp__OpAssignment_1");
					put(grammarAccess.getValueCompAccess().getOpAssignment_2(), "rule__ValueComp__OpAssignment_2");
					put(grammarAccess.getValueCompAccess().getOpAssignment_3(), "rule__ValueComp__OpAssignment_3");
					put(grammarAccess.getValueCompAccess().getOpAssignment_4(), "rule__ValueComp__OpAssignment_4");
					put(grammarAccess.getValueCompAccess().getOpAssignment_5(), "rule__ValueComp__OpAssignment_5");
					put(grammarAccess.getNodeCompAccess().getOpAssignment_0(), "rule__NodeComp__OpAssignment_0");
					put(grammarAccess.getNodeCompAccess().getOpAssignment_1(), "rule__NodeComp__OpAssignment_1");
					put(grammarAccess.getNodeCompAccess().getOpAssignment_2(), "rule__NodeComp__OpAssignment_2");
